...
function Tree(props) {
    var _a, _b, _c, _d;
    var _e = useState(props.open), open = _e[0], setOpen = _e[1];
    var _f = useState(props.visible), visible = _f[0], setVisible = _f[1];
    var _g = useState(false), immediate = _g[0], setImmediate = _g[1];
    var id = useState(props.itemId)[0];
    var toggle = function () {
